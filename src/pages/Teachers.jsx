...
const Teachers = () => {
  const teachersList = [
    ...
    },
    {
      ...
      degree: "M.S. Computer Science, Stanford",
      subjects: "Python, Data Structures, AI",
      experience: "Google Lead Engineer Alumna",
    ...
    <div className="page-wrapper teachers-page">
      ...
      <main className="teachers-main container">
        ...
        <section className="t-join-section">
          ...
          <button className="t-btn-apply">Apply Now</button>
        </section>
      </main>
